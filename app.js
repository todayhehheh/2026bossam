...
/** 미션 데이터 (6개) */
const MISSIONS = [
  { id: 1, emoji: '🔍', image: 'm1.png', name: '재열 돼지의 버킷리스트', detailTitle: '<span style="font-size: 14px; font-weight: 600; color: var(--text-secondary);">재열 돼지의 버킷리스트</span><br><span style="font-size: 26px; font-weight: 800; line-height: 1.4; display: inline-block; margin-top: 4px; color: var(--text-primary);">우리, 진짜 친해진 거 맞지?</span>', desc: '내 버킷리스트는 바로 \'눈빛만 봐도 통하는 진짜 팀\'을 만나보는 거야!<br>너희끼리 꽤 친해졌니? 내가 직접 아주 날카롭게 테스트해 볼게.<br>자신 있다면 [지도]를 열고 사진처럼 분장한 돼지를 찾아!', answer: '보쌈' },
  { id: 2, emoji: '🧩', images: ['m2_1.png', 'm2_2.png', 'm2_3.png', 'm2_4.png'], name: '현정 돼지의 버킷리스트', detailTitle: '<span style="font-size: 14px; font-weight: 600; color: var(--text-secondary);">현정 돼지의 버킷리스트</span><br><span style="font-size: 26px; font-weight: 800; line-height: 1.4; display: inline-block; margin-top: 4px; color: var(--text-primary);">우리만의 기발한 레전드 인증샷</span>', desc: '내 버킷리스트는  \'레전드급 한 장면\'을 만드는 거야!<br>그냥 남들 다 하는 뻔한 인증샷은 재미없잖아?<br>위에 사진을 참고해서 너희만의 기발한 포즈를 보여줘.', type: 'photo', answer: '사진제출' },
  { id: 3, emoji: '🔍', images: ['m3_1.png', 'm3_2.png', 'm3_3.png', 'm3_4.png'], name: '소영 돼지의 버킷리스트', detailTitle: '<span style="font-size: 14px; font-weight: 600; color: var(--text-secondary);">소영 돼지의 버킷리스트</span><br><span style="font-size: 26px; font-weight: 800; line-height: 1.4; display: inline-block; margin-top: 4px; color: var(--text-primary);">흩어진 메시지를 찾아라!</span>', desc: '내 버킷리스트는 바로 \'보물 같은 문장을 완성하는 것\'이지.<br>사진의 표지판을 찾아 분홍 글자를 조합해 단어를 완성해<br>[지도]를 열고 돼지를 눈을 크게 뜨고 찾아봐!', answer: '사랑하자' },
  { id: 4, emoji: '🎵', image: 'm4.png', name: '현수 돼지의 버킷리스트', detailTitle: '<span style="font-size: 14px; font-weight: 600; color: var(--text-secondary);">현수 돼지의 버킷리스트</span><br><span style="font-size: 26px; font-weight: 800; line-height: 1.4; display: inline-block; margin-top: 4px; color: var(--text-primary);">마음의 거리만큼은 0cm</span>', desc: '내 버킷리스트는 \'서로의 호흡까지 맞추는 완벽한 팀\'을 만나는 거야.<br>너희가 얼마나 서로를 믿고 의지하는지 테스트해 볼게.<br>작은 물병 하나를 밀어낼 때도 서로의 믿음이 필요해.', answer: '보쌈런' },
  { id: 5, emoji: '🏃', image: 'm5.png', name: '세라 돼지의 버킷리스트', detailTitle: '<span style="font-size: 14px; font-weight: 600; color: var(--text-secondary);">세라 돼지의 버킷리스트</span><br><span style="font-size: 26px; font-weight: 800; line-height: 1.4; display: inline-block; margin-top: 4px; color: var(--text-primary);">숨겨진 행운을 찾아라!</span>', desc: '내 버킷리스트는 바로 \'보물 같은 행운을 함께 하는 것\'이야.<br>비밀 QR코드들을 숨겨놨어, 단 하나만이 진짜 보물을 품고 있지!<br>진짜 QR코드를 찾아 스캔하면, 마지막 선물이 나타날 거야.', type: 'qr', answer: 'QR스캔' },
  { id: 6, emoji: '🎁', image: 'm6.png', name: '희완 돼지의 버킷리스트', detailTitle: '<span style="font-size: 14px; font-weight: 600; color: var(--text-secondary);">희완 돼지의 버킷리스트</span><br><span style="font-size: 26px; font-weight: 800; line-height: 1.4; display: inline-block; margin-top: 4px; color: var(--text-primary);">너를 칭찬해!</span>', desc: '내 버킷리스트는 \'서로를 칭찬하는 것\'이야.<br>지금 바로 노원구 꿈드림 센터 지하 1층으로 내려가 봐.<br>\'칭찬카드\'에 따뜻한 칭찬을 정성껏 적어서 상자에 넣어줘.', answer: '꿈드림' },
];
